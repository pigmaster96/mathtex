...
\indent Finally we show that $R$ is transitive. Let $x,y,z$ be arbitrary elements in $A$. Suppose $(x,y)\in R$ and $(y,z)\in R$, where $R=\in\bigcup_{X\in\mathcal F}(X\times X)$. 
