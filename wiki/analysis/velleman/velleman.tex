...
\end{definition}
\begin{theorem}
Suppose $A$ is a set, $\mathcal F\subseteq\mathscr P(A)$, and $\mathcal F\neq\emptyset$. Then the least upper bound of $\mathcal F$ (in the subset partial order) is $\bigcup\mathcal F$ and the
greatest lower bound of $\mathcal F$ is $\bigcap\mathcal F$.
\end{theorem}
